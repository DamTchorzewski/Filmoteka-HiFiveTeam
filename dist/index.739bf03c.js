...
var _trendingMoviesPaginationJs = require("./TrendingMoviesPagination.js");

},{"./modalTeam.js":"eHqPO","./pagination":"9j1Dd","./search.js":"4TESp","./modalWindow.js":"1NUsw","./btnModal.js":"eTtSt","./TrendingMoviesPagination.js":"iA0Jh"}],"eHqPO":[function(require,module,exports) {
...
const setPagination = (totalItems, refs)=>{
    const options = {
        totalItems,
        itemsPerPage: 20,
        visiblePages: 5,
    ...
    const pagination = new (0, _tuiPaginationDefault.default)(refs.pagination, options);
    return pagination;
};
...
(0, _refsDefault.default).errorMessage.style.display = "none";
const searchMovie = async (e, currentPage = 1)=>{
    e.preventDefault();
    (0, _refsDefault.default).errorMessage.style.display = "none";
    (0, _refsDefault.default).moviesGallery.innerHTML = "";
    const searchValue = (0, _refsDefault.default).input.value.trim();
    ...
    try {
        const data = await (0, _apiDefault.default).getMoviesByQuery(searchValue, currentPage);
        const paginationSearch = (0, _pagination.setPagination)(data.total_results, (0, _refsDefault.default));
        if (data.results.length === 0) {
            (0, _refsDefault.default).errorMessage.style.display = "block";
            (0, _refsDefault.default).pagination.style.display = "none";
        } else {
            (0, _refsDefault.default).errorMessage.style.display = "none";
            ...
            paginationSearch.on("afterMove", ()=>{
                ...
                if (firstMovieCard) firstMovieCard.scrollIntoView({
                    behavior: "smooth",
                    block: "start"
                });
                const paginationContainer = (0, _refsDefault.default).pagination.parentNode;
                const movieCards = document.querySelectorAll(".movie-card");
                const lastMovieCard = movieCards[movieCards.length - 1];
                if (lastMovieCard) paginationContainer.insertBefore((0, _refsDefault.default).pagination, lastMovieCard.nextSibling);
            });
        }
    } catch (error) {
        console.error(error);
...
(0, _refsDefault.default).searchBtn.addEventListener("click", (e)=>searchMovie(e, 1));

},{"./refs":"2WoF2","./pagination":"9j1Dd","./api":"9u7qN","./renderMovieCards.js":"aGLN1","./loader":"aAovl","./scrollTop":"iQ4CA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9u7qN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aGLN1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function renderMovieCard(movies) {
    const markup = movies.map(({ id: id1 , title , name , release_date , first_air_date , poster_path , genre_ids ,  })=>{
        ...
        return `<li class="movie-container__card" data-id="${id1}">
...
},{"./api.js":"9u7qN","./genres.js":"2f7DF","./refs.js":"2WoF2","../images/moviesGallery/noImg.jpg":"abGVB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2f7DF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1NUsw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./refs":"2WoF2","../images/moviesGallery/noImg.jpg":"abGVB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7RFuK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _refs = require("./refs");
var _refsDefault = parcelHelpers.interopDefault(_refs);
...
},{"./refs":"2WoF2","./localStorage":"45bAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iA0Jh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _tuiPagination = require("tui-pagination");
var _tuiPaginationDefault = parcelHelpers.interopDefault(_tuiPagination);
var _pagination = require("./pagination");
...
const initTrendingMoviesPagination = async ()=>{
    const setPagination = (totalItems)=>{
        ...
        pagination.on("beforeMove", async ({ page  })=>{
            ...
            (0, _refsDefault.default).footer.style.display = "none";
            try {
                const data = await (0, _apiDefault.default).getTrendingMovies(page);
                setTimeout(()=>{
                    (0, _loaderDefault.default).hide((0, _refsDefault.default).loader);
                    (0, _refsDefault.default).pagination.style.display = "block";
                    (0, _refsDefault.default).footer.style.display = "block";
    ...
    try {
        const data = await (0, _apiDefault.default).getTrendingMovies();
...
},{"tui-pagination":"b80gR","./pagination":"9j1Dd","./refs":"2WoF2","./api":"9u7qN","./renderMovieCards.js":"aGLN1","./loader":"aAovl","./scrollTop":"iQ4CA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aRq6p","ebWYT"], "ebWYT", "parcelRequirecbc0")
